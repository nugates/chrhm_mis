...
function GetCustomerDetails() {
    Req = 'CustomerList';
    obj = "Fill";
    url = "CarrierDetailsList.aspx/CustomerDetails";
    ht = {};
    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">ID</th><th>Carrier Name</th><th>Account Number</th><th>Country</th><th>State</th><th>City</th><th>Address1</th><th class=' + _allowedit + '>Edit</th><th  class=' + _allowdelete + '>Delete</th></tr></thead> <tbody>';
...
function CustomerDetailsEdit(id) {
    ...
    window.location = 'CreateCarrierDetails.aspx?' + bt;
}

function redirect() {
    window.location = 'CreateCarrierDetails.aspx';
}
