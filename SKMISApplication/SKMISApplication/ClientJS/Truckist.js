...
$(document).ready(function () {
    ...
    // *******************************start permissionm**************************
    permissionforlist('TruckList.aspx', 'CreateTruck.aspx', 'btn_create');
    // *******************************end permissionm**************************
    setTimeout(function () {
        GetTruckDetails();
    }, 2000);
    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">Truck ID</th><th>Truck Type</th><th>Description</th><th  class=' + _allowedit + '>Edit</th><th  class=' + _allowdelete + '>Delete</th></tr></thead> <tbody>';
                $.each(data, function (i, item) {
                    ...
                    table = table + "<tr><td style='display:none' >" + item.ID +
                                    "</td><td>" + item.TruckType +
                                    "</td><td>" + item.Truckdescription +
...
function redirect() {
    window.location = 'CreateTruck.aspx';
}


function TruckEdit(id) {
    var bt = btoa("tid=" + id + "");
    window.location = 'CreateTruck.aspx?' + bt;
}
