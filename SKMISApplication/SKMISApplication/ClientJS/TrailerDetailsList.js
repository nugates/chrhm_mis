...
function GetTruckDetails() {
    Req = 'TruckList';
    obj = "Fill";
    url = "TrailerDetailsList.aspx/TruckDetails";
    ht = {};
    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">ID</th><th>Status</th><th>Unit Number</th><th>Owner</th><th>VIN</th><th>Serial Number</th><th>Title Number</th><th>License Plate Number</th><th class=' + _allowedit + '>Edit</th><th  class=' + _allowdelete + '>Delete</th></tr></thead> <tbody>';
...
function TruckDetailsEdit(id) {
    ...
    window.location = 'CreateTrailerDetails.aspx?' + bt;
}

function redirect() {
    window.location = 'CreateTrailerDetails.aspx';
}
