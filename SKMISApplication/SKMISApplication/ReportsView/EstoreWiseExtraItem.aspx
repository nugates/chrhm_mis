<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstoreWiseExtraItem.aspx.cs" Inherits="SKMISApplication.ReportsView.EstoreWiseExtraItems" %>
            ...
            <div id="container">
                <div id="main">
                    <div style="margin: 0 auto; text-align: left; width: 800px;">
                        ...
                        <rsweb:ReportViewer ID="estoreExtraRpt" runat="server" PageCountMode="Actual" DocumentMapWidth="30%" SizeToReportContent="True" HyperlinkTarget="_blank"></rsweb:ReportViewer>
                    </div>
