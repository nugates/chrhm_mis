<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorDetails.aspx.cs" Inherits="SKMISApplication.ReportsView.VendorDetails" %>
        ...
        <div id="table-container">
            ...
            <div id="container">
                <div id="main">
                    ...
                    <rsweb:ReportViewer ID="vendordetailRpt" runat="server" PageCountMode="Actual" DocumentMapWidth="30%" SizeToReportContent="True" HyperlinkTarget="_blank"></rsweb:ReportViewer>
                    </div>
