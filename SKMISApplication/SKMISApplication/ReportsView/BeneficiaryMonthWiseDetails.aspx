<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BeneficiaryMonthWiseDetails.aspx.cs" Inherits="SKMISApplication.ReportsView.BeneficiaryMonthWiseDetails" %>
        ...
        <div id="table-container">
            ...
            <div id="container">
                <div id="main">
                    ...
                    <rsweb:ReportViewer ID="estoredetailRpt" runat="server" PageCountMode="Actual" DocumentMapWidth="30%" SizeToReportContent="True" HyperlinkTarget="_blank"></rsweb:ReportViewer>
                    </div>
