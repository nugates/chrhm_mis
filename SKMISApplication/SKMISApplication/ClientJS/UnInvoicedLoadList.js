...
function GetLoadDetails() {
    Req = 'LoadList';
    obj = "Fill";
    url = "UnInvoicedLoadList.aspx/AllLoadDetails";
    ht = {};
    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">Load ID</th><th>Load Number</th><th>Load Type</th><th>Type</th><th>Name</th><th>Load Date</th><th>Load Time</th><th>Reference</th><th>Invoice</th><th  class=' + _allowedit + '>Edit</th><th  class=' + _allowdelete + '>Delete</th></tr></thead> <tbody>';
                                     ...
                                     "</td><td>" + item.Load_Date +
                                      "</td><td>" + item.Load_Time +
                                       "</td><td>" + item.Reference +
                                        "</td><td><input id=status_" + item.ID + " class='btn btn-block btn-primary'  onclick=LoadInvoice(" + item.ID + ") type='button' value='Create Invoice' />" +
