...
function GetCustomerDetails() {
    Req = 'CustomerList';
    obj = "Fill";
    url = "ConsigneeDetailsList.aspx/CustomerDetails";
    ht = {};
    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">ID</th><th>Company Name</th><th>DBA Name</th><th>EIN</th><th>Account Number</th><th>Contact Name</th><th>Phone Number</th><th>Email</th><th class=' + _allowedit + '>Edit</th><th  class=' + _allowdelete + '>Delete</th></tr></thead> <tbody>';
...
function CustomerDetailsEdit(id) {
    ...
    window.location = 'CreateConsigneeDetails.aspx?' + bt;
}

function redirect() {
    window.location = 'CreateConsigneeDetails.aspx';
}
