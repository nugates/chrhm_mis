...
$(document).ready(function () {
    ...
    // *******************************start permissionm**************************
    permissionforlist('FuelVendorList.aspx', 'CreateFuelVendor.aspx', 'btn_create');
    // *******************************end permissionm**************************
...
function GetAddressDetails() {
    Req = 'AddressList';
    obj = "Fill";
    url = "FuelVendorList.aspx/AddressDetails";
    ht = {};
...
function redirect() {
    window.location = 'CreateFuelVendor.aspx';
}
...
function AddressEdit(id) {
    ...
    window.location = 'CreateFuelVendor.aspx?' + bt;
}
